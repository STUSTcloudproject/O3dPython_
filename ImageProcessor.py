...
class ImageProcessor:
    ...
    def process_image(self, image_data, color_mode, target_width, target_height):
    ...
    def process_and_resize_color_image(self, color_image, target_width, target_height):
        return self.process_image(color_image, cv2.COLOR_BGR2RGB, target_width, target_height)

    def process_and_resize_depth_image(self, depth_image, target_width, target_height):
        return self.process_image(depth_image, "depth", target_width, target_height)

    def process_and_resize_infrared_image(self, infrared_image, target_width, target_height):
        return self.process_image(infrared_image, cv2.COLOR_GRAY2RGB, target_width, target_height)
